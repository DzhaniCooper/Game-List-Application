...
namespace MvcGame.Controllers
{
    public class GamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ImgUrl,Title,ReleaseDate,Genre,Price,Rating")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,Rating,ImgUrl")] Game game)
        {
            if (ModelState.IsValid)
            {
